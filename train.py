...
def main(flags):
    ...
    with tf.control_dependencies(update_ops):
        training_op = train_op(loss_fuse,learning_rate)


    train_csv = tf.train.string_input_producer(['pig2.csv'])
    test_csv = tf.train.string_input_producer(['pigtest2.csv'])
