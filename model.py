...
def unet(input,training):
    ...
    conv1_1 = conv2d(input, (3, 3), [64], training, name='conv1_1')       #卷积两次输出维度64维
    ...
    score_dsn6_up = deconv2d(conv3_dsn6,64,32,training,name='upsample32_in_dsn6_sigmoid-dsn6',output_shape=[batch_size,h,w,1],activation=tf.nn.sigmoid)
    ...
    score_dsn5_up = deconv2d(conv3_dsn5, 32, 16, training, name='upsample16_in_dsn5_sigmoid-dsn5',output_shape=[batch_size,h,w,1],activation=tf.nn.sigmoid)
    ...
    score_dsn4_up = deconv2d(conv4_dsn4, 16, 8, training, name='upsample8_in_dsn4_sigmoid-dsn4',output_shape=[batch_size,h,w,1],activation=tf.nn.sigmoid)
    ...
    score_dsn3_up = deconv2d(conv4_dsn3, 8, 4, training, name='upsample4_in_dsn3_sigmoid-dsn3',output_shape=[batch_size,h,w,1],activation=tf.nn.sigmoid)
    ...
    score_dsn2_up = deconv2d(conv4_dsn2, 4, 2, training, name='upsample2_in_dsn2_sigmoid-dsn2',output_shape=[batch_size,h,w,1],activation=tf.nn.sigmoid)
